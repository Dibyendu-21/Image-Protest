...
tr_gen = gen()
tr_gen1 = gen1()
m_check=keras.callbacks.ModelCheckpoint(filepath='./protest.h5',monitor='loss', verbose=0, save_best_only=True, mode='min')
history=model.fit_generator(generator=tr_gen, steps_per_epoch=count, nb_epoch=5, validation_data=tr_gen1, validation_steps=count1, max_queue_size=2,callbacks=[m_check])
