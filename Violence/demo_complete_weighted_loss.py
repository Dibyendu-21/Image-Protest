# -*- coding: utf-8 -*-
"""
Created on Sat Nov  3 11:04:22 2018
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 25 20:17:28 2018
...
conv_0=Conv2D(32, (3, 3), activation='relu')(input_shape)
...
POS_WEIGHT1 = 0.1
def weighted_binary_crossentropy1(target, output):
    """
...
model1.compile(loss=[weighted_binary_crossentropy1,weighted_binary_crossentropy2], optimizer='rmsprop',metrics=[mcc,roc_auc_score,fmeasure,'accuracy'])

model1.fit(np.array(data_train),[np.array(target1_train),np.array(target2_train)], batch_size=batch_size, nb_epoch=nb_epoch, verbose=1, validation_data=(np.array(data_test),[np.array(target1_test),np.array(target2_test)]))
