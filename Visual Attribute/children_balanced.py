# -*- coding: utf-8 -*-
"""
Created on Sun Apr 28 19:31:51 2019
...
def read(filename):
    df = pd.read_csv(filename, nrows=2640)
    print(df.head())
    label = df['children']
...
def gen():
    ...
    while True: 
        for i in range(0,55):
            ...
            itera1 = islice(label_train, i*27, (i+1)*27)
            for img in itera:
                iteru.append(img)
            for img in itera1:
                iteru1.append(img)
...
def gen1():
    ...
    while True: 
        for i in range(0,33):
            iteru = []
            iteru1 = []
            itera = islice(data_holdout, i*20, (i+1)*20)
            itera1 = islice(label_holdout, i*20, (i+1)*20)
            for img in itera:
                iteru.append(img)
            for img in itera1:
                iteru1.append(img)
...
def gen2():
    ...
    while True: 
        for i in range(0,15):
            iteru = []
            iteru1 = []
            itera = islice(data_test, i*33, (i+1)*33)
            itera1 = islice(label_test, i*33, (i+1)*33)
            for img in itera:
                iteru.append(img)
            for img in itera1:
                iteru1.append(img)
